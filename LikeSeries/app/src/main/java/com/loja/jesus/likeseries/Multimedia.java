...
public class Multimedia {
    ...
    private int votosPositivos_Pelicula,votosNegativos_Pelicula,votantes_Pelicula,votosPositivos_Serie,votosNegativos_Serie,votantes_Serie,NCapitulos,notamedia_Pelicula,notamedia_Serie;
    ...
    public int getNotamedia_Pelicula() {
        return notamedia_Pelicula;
    }

    public void setNotamedia_Pelicula(int notamedia_Pelicula) {
        this.notamedia_Pelicula = notamedia_Pelicula;
    }

    public int getNotamedia_Serie() {
        return notamedia_Serie;
    }

    public void setNotamedia_Serie(int notamedia_Serie) {
        this.notamedia_Serie = notamedia_Serie;
    }
