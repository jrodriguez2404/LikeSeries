...
public class AdaptadorMutimediaLike extends RecyclerView.Adapter<AdaptadorMutimediaLike.ViewHolderMultimedia> {
    ...
    Context context;
    public AdaptadorMutimediaLike(Context contexto, ArrayList<Multimedia> listaMultimedia) {
    ...
    @NonNull
    @Override
    public AdaptadorMutimediaLike.ViewHolderMultimedia onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final AdaptadorMutimediaLike.ViewHolderMultimedia viewHolderMultimedia, final int i) {
